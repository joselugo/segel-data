...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="<?= base_url() ?>public/favicon.ico">
    ...
    <div id="page-container" class="fade show">
        ...
        <div class="login login-v2 animated fadeIn" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-header">
                <div class="brand">
                    <img src="http://app.netium.com.mx/admin/images/logo.png" alt="" class="img-responsive" style="max-width:260px; height:auto">
                </div>
                <div class="icon">
