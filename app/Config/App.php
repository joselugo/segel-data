...
class App extends BaseConfig
{
	...
	|
	*/
	/* public $baseURL = 'http://165.227.85.204/'; */ //en caso de caer los DNS descomentar
	//public $baseURL = 'http://hybricom.com.mx/'; //ruta por DNS
	public $baseURL = 'http://localhost/segel/';
